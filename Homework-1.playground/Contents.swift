...
## 1. Optional String (if statement)
 ...
 The Swift code below will set variable `password` to something; it might be an actual string, or it might be nil (no value).
 ...
 Make sure to try out your code for different values of password -- any time you add or remove code, the Playground should execute again and set password to a new value.  Alternately, you can also do Editor -> Execute Playground to get a new password.
*/
